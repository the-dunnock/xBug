...
xBug is a base Extra template that is useful when wanting to create a new
...
`git clone http://github.com/splittingred/xBug.git ./`

Then, create the target directory where you want to create the file.

Then, navigate to the directory xBug is now in, and do this:
...
Now, you'll want to change references to xBug in the files in your
new copied-from-xBug repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'xBug' to whatever the
name of your component is.

## Copyright Information

xBug is distributed as GPL (as MODx Revolution is), but the copyright owner
(Shaun McCormick) grants all users of xBug the ability to modify, distribute
and use xBug in MODx development as they see fit, as long as attribution
